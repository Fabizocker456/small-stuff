...
class Type(AST):
    def __init__(self, name: str, value: typing.Union["Sum", "Product"]):
        self.name = name
        self.value = value
...
class Constructor(AST):
    def __init__(self, name: str, fields: typing.Optional[list["Field"]] = None):
        self.name = name
...
class Field(AST):
    def __init__(
        self, type: str, name: typing.Optional[str] = None, seq=False, opt=False
    ):
        self.type = type
        self.name = name
        self.seq = seq
...
class Sum(AST):
    def __init__(
        self, types: list[Constructor], attributes: typing.Optional[list[Field]] = None
    ):
        self.types = types
...
class Product(AST):
    def __init__(
        self, fields: list[Field], attributes: typing.Optional[list[Field]] = None
    ):
        self.fields = fields
        self.attributes = attributes or []
